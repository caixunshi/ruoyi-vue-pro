    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="开始时间" prop="openTime">
          <el-time-picker clearable v-model="form.openTime" type="date" value-format="HHmm" placeholder="选择营业时间">
          </el-time-picker>
        </el-form-item>
        <el-form-item label="结束时间" prop="closeTime">
          <el-time-picker clearable v-model="form.closeTime" type="date" value-format="HHmm" placeholder="选择营业时间">
          </el-time-picker>
        </el-form-item>
...
<script>
import { createStoreInfo, updateStoreInfo, deleteStoreInfo, getStoreInfo, getStoreInfoPage, exportStoreInfoExcel } from "@/api/mp/storeInfo";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        labels: [{ required: false, message: "标签不能为空", trigger: "blur" }],
        latitude: [{ required: true, message: "纬度不能为空", trigger: "blur" }],
        status: [{ required: true, message: "请选择门店状态", trigger: "blur" }],
