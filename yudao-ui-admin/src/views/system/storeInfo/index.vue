    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="状态" align="center" prop="status">
        <template v-slot="scope">
          <dict-tag :type="DICT_TYPE.SYSTEM_STORE_STATUS" :value="scope.row.status" />
        </template>
      </el-table-column>
      <el-table-column label="开始时间" align="center" prop="openTime" />
      <el-table-column label="结束时间" align="center" prop="closeTime" />
